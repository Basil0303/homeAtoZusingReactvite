                ...
                <div className="card-header p-2 border-0">
                  <div className="d-flex">
                    <div className="icon-box bg-primary-light rounded-circle">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 24 24" version="1.1" className="svg-main-icon">
                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                          <polygon points="0 0 24 0 24 24 0 24" />
                          <path d="M18,8 L16,8 C15.4477153,8 15,7.55228475 15,7 C15,6.44771525 15.4477153,6 16,6 L18,6 L18,4 C18,3.44771525 18.4477153,3 19,3 C19.5522847,3 20,3.44771525 20,4 L20,6 L22,6 C22.5522847,6 23,6.44771525 23,7 C23,7.55228475 22.5522847,8 22,8 L20,8 L20,10 C20,10.5522847 19.5522847,11 19,11 C18.4477153,11 18,10.5522847 18,10 L18,8 Z M9,11 C6.790861,11 5,9.209139 5,7 C5,4.790861 6.790861,3 9,3 C11.209139,3 13,4.790861 13,7 C13,9.209139 11.209139,11 9,11 Z" fill="var(--primary)" fillRule="nonzero" opacity="0.3" />
                          <path d="M0.00065168429,20.1992055 C0.388258525,15.4265159 4.26191235,13 8.98334134,13 C13.7712164,13 17.7048837,15.2931929 17.9979143,20.2 C18.0095879,20.3954741 17.9979143,21 17.2466999,21 C13.541124,21 8.03472472,21 0.727502227,21 C0.476712155,21 -0.0204617505,20.45918 0.00065168429,20.1992055 Z" fill="var(--primary)" fillRule="nonzero" />
                        </g>
                      </svg>
                    </div>
                    <div className="ms-2 add-visit">
                      <h6 className="mb-0">Add visitors</h6>
                      <span>3,569</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="card">
                <div className="card-header p-2 border-0">
                  <div className="d-flex">
                    ...
                    <div className="ms-2 add-visit">
                      <h6 className="mb-0">sessions Start</h6>
                      <span>8:30 PM</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="d-flex">
                    <div className="icon-box bg-info-light rounded-circle">
                      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" className="svg-main-icon">
                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                          <polygon points="0 0 24 0 24 24 0 24" />
                          <path d="M12,11 C9.790861,11 8,9.209139 8,7 C8,4.790861 9.790861,3 12,3 C14.209139,3 16,4.790861 16,7 C16,9.209139 14.209139,11 12,11 Z" fill="#58bad7" fillRule="nonzero" opacity="0.3" />
                          <path d="M3.00065168,20.1992055 C3.38825852,15.4265159 7.26191235,13 11.9833413,13 C16.7712164,13 20.7048837,15.2931929 20.9979143,20.2 C21.0095879,20.3954741 20.9979143,21 20.2466999,21 C16.541124,21 11.0347247,21 3.72750223,21 C3.47671215,21 2.97953825,20.45918 3.00065168,20.1992055 Z" fill="#58bad7" fillRule="nonzero" />
                        </g>
                      </svg>
                    </div>
                    <div className="ms-2 add-visit">
                      <h6 className="mb-0">Total Live</h6>
                      <span>5,586
                      </span>
                    </div>
                  </div>
    ...
    <div className="col-xl-5">
      <div className="card">
        ...
        <div className="card-body custome-tooltip">
          <div className="row">
            <div className="col-xl-3 col-3 or-series">
                ...
                <table id="empoloyeestbl2" className="table market-update">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="images/crm/dribble.png" className="avatar avatar-lg" alt />
                          <div className="ms-2 dr-data">
                            <h6 className="mb-0">Dribble</h6>
                            <span>50 Template</span>
                          </div>
                        </div>
                      </td>
                      <td>Meta</td>
                      <td className="text-success"><i className="fa-solid fa-arrow-trend-up me-1" /> 2.556</td>
                      <td>$4,3655</td>
                      <td><span className="badge badge-success light border-0">Active</span></td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="images/crm/facebook.png" className="avatar avatar-lg" alt />
                          <div className="ms-2 dr-data">
                      ...
                      <td>Space</td>
                      <td className="text-danger"><i className="fa-solid fa-arrow-trend-down me-1" /> 2.556</td>
                      <td>$3,2342</td>
                      <td><span className="badge badge-danger light border-0">Inactive</span></td>
                      <td>
                        <div className="dropdown">
                          <div className="btn-link" data-bs-toggle="dropdown">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="images/crm/instagram.png" className="avatar avatar-lg" alt />
                          <div className="ms-2 dr-data">
                            <h6 className="mb-0">Facebook</h6>
                            <span>60 Ads</span>
                          </div>
                      ...
                      <td>Meta</td>
                      <td className="text-success"><i className="fa-solid fa-arrow-trend-down me-1" /> 4.556</td>
                      <td>$4,3655</td>
                      <td><span className="badge badge-success light border-0">DeActive</span></td>
                      <td>
                        <div className="dropdown">
                          <div className="btn-link" data-bs-toggle="dropdown">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="images/crm/linkedin.png" className="avatar avatar-lg" alt />
                          <div className="ms-2 dr-data">
                      ...
                      <td>Meta</td>
                      <td className="text-success"><i className="fa-solid fa-arrow-trend-down me-1" /> 2.556</td>
                      <td>$4,3655</td>
                      <td><span className="badge badge-success light border-0">DeActive</span></td>
                      <td>
                        <div className="dropdown">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="images/crm/bing.png" className="avatar avatar-lg" alt />
                          <div className="ms-2 dr-data">
                            <h6 className="mb-0">Bing</h6>
                            <span>30-50 Ads</span>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="text-success"><i className="fa-solid fa-arrow-trend-down me-1" /> 2.556</td>
                      <td>$4,3655</td>
                      <td><span className="badge badge-primary light border-0">Pending</span></td>
                      <td>
                        <div className="dropdown">
                          <div className="btn-link" data-bs-toggle="dropdown">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="images/crm/twitter.png" className="avatar avatar-lg" alt />
                          <div className="ms-2 dr-data">
                            <h6 className="mb-0">Twitter Ads</h6>
                            <span>20-60 Ads</span>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <img src="images/crm/whatsapp.png" className="avatar avatar-lg" alt />
                          <div className="ms-2 dr-data">
                            <h6 className="mb-0">Whatsapp Ads</h6>
                            <span>20-60 Ads</span>
                          </div>
                        </div>
                      </td>
          ...
          <div className="card sale-card">
            <div className="card-header pb-0 border-0 align-items-baseline">
              <div>
                ...
                <h4>$1,255 <i className="fa-solid fa-arrow-trend-up ms-1" /></h4>
              </div>
              <span className="badge badge-primary border-0">3.5<i className="fa-solid fa-caret-up ms-1" /></span>
            </div>
            <div className="card-body p-0 custome-tooltip">
              <div id="totalSale" />
            </div>
            <div className="card-footer border-0">
              <span className="tag bg-primary">
          ...
          <div className="card sale-card">
            <div className="card-header pb-0 border-0 align-items-baseline">
              <div>
                ...
                <h4>5,552k <i className="fa-solid fa-arrow-trend-down ms-1" /></h4>
              </div>
              <span className="badge badge-secondary border-0">5.5<i className="fa-solid fa-caret-down ms-1" /></span>
            </div>
            <div className="card-body p-0 custome-tooltip">
          ...
          <div className="card sale-card">
            <div className="card-header pb-0 border-0 align-items-baseline">
              <div>
                ...
                <h4>3,431k <i className="fa-solid fa-arrow-trend-down ms-1" /></h4>
              </div>
              <span className="badge badge-info border-0">6.5<i className="fa-solid fa-caret-down ms-1" /></span>
            </div>
            <div className="card-body p-0 custome-tooltip">
              <div id="activeCustomers" />
            </div>
            <div className="card-footer border-0">
              <span className="tag bg-info">
                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18" /><polyline points="17 6 23 6 23 12" /></svg>
              </span>
            </div>	
          </div>
        ...
        <div className="col-xl-12">
          <div className="card">
            <div className="card-header border-0 chart-card">
              <div className="d-flex align-items-center">
                <img src="images/crm/pie-chart.png" alt />
                <div className="ms-2">
                  <h4 className="mb-0">1,555k <small className="fs-12 text-success"><i className="fa-solid fa-arrow-trend-down mx-2" />(3.56)</small></h4>
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="ms-2">
                  <h4 className="mb-0">1,5832k <small className="fs-12 text-success"><i className="fa-solid fa-arrow-trend-up mx-2" />(5.66)</small></h4>
                  <span>Lorem Ipsum</span>
                </div>
              </div>
              <div className="d-flex align-items-center">
                <div className="icon-box bg-secondary-light rounded-circle">
                  <svg width={20} height={20} viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M22.9717 41.0539C22.9717 41.0539 37.3567 36.6983 37.3567 24.6908C37.3567 12.6814 37.878 11.7439 36.723 10.5889C35.5699 9.43391 24.858 5.69891 22.9717 5.69891C21.0855 5.69891 10.3736 9.43391 9.21863 10.5889C8.0655 11.7439 8.58675 12.6814 8.58675 24.6908C8.58675 36.6983 22.9717 41.0539 22.9717 41.0539Z" stroke="var(--secondary)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M26.4945 26.4642L19.4482 19.4179" stroke="var(--secondary)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M19.4487 26.4642L26.495 19.4179" stroke="var(--secondary)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <div className="ms-2">
                  <h4 className="mb-0">5:22:23<small className="fs-12 text-success"><i className="fa-solid fa-arrow-trend-down mx-2" />(3.56)</small></h4>
