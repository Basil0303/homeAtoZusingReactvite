...
function Hometype() {
  ...
  const handleEdit = async () => {
    ...
    var data = editedItem;
    await apiCall("put", `${homeUrl}/${editedItem.id}`, { data });
    handleClose();
    getHome();
  };
  ...
  const EditData = (item) => {
    console.log(item);
    setEditedItem({ id: item._id, name: item.name, image: item.image });
    setEdit(true);
  };
                    ...
                    <a href={undefined}>
                      ...
                      >
                        <g clipPath="url(#clip0_1_450)">
                          ...
                          />
                          <path
                            d="M11 16C13.7614 16 16 13.7614 16 11C16 8.23859 13.7614 6.0handleFieldChange0002 11 6.00002C8.23858 6.00002 6 8.23859 6 11C6 13.7614 8.23858 16 11 16ZM11 18C7.13401 18 4 14.866 4 11C4 7.13402 7.13401 4.00002 11 4.00002C14.866 4.00002 18 7.13402 18 11C18 14.866 14.866 18 11 18Z"
                            fill="#452B90"
                          />
                        </g>
                        <defs>
            ...
            <div className="basic-form">
              ...
              >
                <Form.Group as={Col} controlId="validationCustom01">
                  <Form.Label className="mb-1">Type name</Form.Label>
